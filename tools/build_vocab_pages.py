...
<body>
<nav class="crumb"><a href="../index.html">← 首頁</a><a href="index.html">單字課程</a><a href="../hiragana-quiz.html">單字測驗</a></nav>
...
<p class="chapter-cta"><a href="../hiragana-quiz.html">到單字測驗練這批字 →</a></p>
...
<body>
<nav class="crumb"><a href="../index.html">← 首頁</a><a href="../hiragana-quiz.html">單字測驗</a></nav>
...
{chr(10).join(lis)}
  ...
  <p class="chapter-cta"><a href="../hiragana-quiz.html">開始單字測驗 →</a></p>
</main>
</body>
</html>
'''
